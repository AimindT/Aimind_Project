...
import 'package:aimind/screens/functionalities_Screens/terapia_Rapida_Screen/SmilePainter.dart';
...
class _FastTherapyScreenState extends State<FastTherapyScreen>
  ...
  void initState() {
    ...
    arcItems.addAll([badArcItem, ughArcItem, okArcItem, goodArcItem]);
